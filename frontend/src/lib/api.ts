...
export const categoryCatalog = [
  ...
  },
  {
    ...
    slug: 'generators',
    name: 'Generators',
    description: 'UUID, password, mock data, gitignore, blob, and icon generators',
    toolCount: 13,
  },
  {
    id: 4,
  ...
  },
  {
    ...
    slug: 'converters',
    name: 'Converters',
    description: 'Data format, CSS unit, SQL, and table converters',
    toolCount: 15,
  },
  {
    id: 7,
  ...
  },
  {
    ...
    description: 'HTTP, SEO, robots.txt, Dockerfile, CSS Grid, security, and request utilities',
    toolCount: 18,
  },
...
const curatedRelatedToolSlugs: Record<string, string[]> = {
  ...
  'base64': ['image-to-base64', 'hex-encoder', 'jwt-decoder'],
  'image-to-base64': ['favicon-generator', 'base64', 'svg-to-jsx'],
  ...
  'markdown-preview': ['csv-to-markdown', 'lorem-ipsum', 'word-counter'],
  ...
  'user-agent-parser': ['http-headers-parser', 'cidr-calculator', 'url-parser'],
  ...
  'chmod-calculator': ['cidr-calculator', 'cron-generator', 'timestamp-converter'],
  ...
  'html-formatter': ['html-table-to-json', 'html-minifier', 'xml-formatter'],
  ...
  'px-to-rem': ['css-grid-generator', 'css-clamp', 'css-box-shadow'],
  'mock-data-generator': ['uuid-generator', 'json-formatter', 'json-to-models'],
  'csv-to-markdown': ['json-csv', 'markdown-preview', 'html-table-to-json'],
  ...
  'svg-optimizer': ['css-blob-generator', 'svg-minifier', 'svg-to-jsx'],
  'html-table-to-json': ['sql-to-json', 'csv-to-markdown', 'html-formatter'],
  'favicon-generator': ['image-to-base64', 'svg-optimizer', 'meta-tags'],
  ...
  'css-glassmorphism': ['css-box-shadow', 'css-gradient', 'css-blob-generator'],
  'css-grid-generator': ['css-clamp', 'css-glassmorphism', 'px-to-rem'],
  'css-blob-generator': ['css-glassmorphism', 'css-gradient', 'svg-optimizer'],
