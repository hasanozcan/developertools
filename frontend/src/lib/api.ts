...
export const categoryCatalog = [
  ...
  },
  {
    ...
    slug: 'generators',
    name: 'Generators',
    description: 'UUID, password, mock data, and icon generators',
    toolCount: 11,
  },
  {
    id: 4,
    slug: 'crypto',
    name: 'Cryptography',
    description: 'Hashing, message authentication, certificates, key pairs, and OAuth security tools',
    toolCount: 9,
  },
  {
    id: 5,
  ...
  },
  {
    ...
    slug: 'converters',
    name: 'Converters',
    description: 'Data format, CSS unit, and table converters',
    toolCount: 14,
  },
  {
    id: 7,
...
const curatedRelatedToolSlugs: Record<string, string[]> = {
  ...
  'slug-generator': ['uuid-generator', 'meta-tags', 'qr-code'],
  'qr-code': ['url-encoder', 'uuid-generator', 'slug-generator'],
  ...
  'meta-tags': ['favicon-generator', 'css-gradient', 'slug-generator'],
  'md5-hash': ['sha256-hash', 'sha512-hash', 'hmac-generator'],
  'sha256-hash': ['certificate-decoder', 'pkce-generator', 'bip39-generator'],
  ...
  'bcrypt-generator': ['password-generator', 'sha512-hash', 'md5-hash'],
  ...
  'css-clamp': ['px-to-rem', 'css-box-shadow', 'color-contrast-checker'],
  'css-box-shadow': ['px-to-rem', 'css-clamp', 'color-converter'],
  'docker-run-to-compose': ['cron-generator', 'chmod-calculator', 'env-to-json'],
  ...
  'json-to-sql': ['sql-formatter', 'json-csv', 'json-to-models'],
  'bip39-generator': ['password-generator', 'sha256-hash', 'uuid-generator'],
  'dmarc-generator': ['http-headers-parser', 'certificate-decoder', 'csp-builder'],
  'json-to-models': ['mock-data-generator', 'sql-formatter', 'json-to-sql'],
  'px-to-rem': ['css-clamp', 'css-box-shadow', 'css-gradient'],
  ...
  'svg-optimizer': ['svg-minifier', 'svg-to-jsx', 'css-gradient'],
  'html-table-to-json': ['csv-to-markdown', 'json-csv', 'html-formatter'],
