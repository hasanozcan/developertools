...
const curatedRelatedToolSlugs: Record<string, string[]> = {
  ...
  'json-csv': ['json-to-sql', 'sql-formatter', 'yaml-json'],
  ...
  'image-to-base64': ['base64', 'svg-to-jsx', 'svg-minifier'],
  ...
  'password-generator': ['bcrypt-generator', 'bip39-generator', 'uuid-generator'],
  'slug-generator': ['uuid-generator', 'meta-tags', 'qr-code'],
  'qr-code': ['url-encoder', 'uuid-generator', 'slug-generator'],
  'lorem-ipsum': ['word-counter', 'slug-generator', 'uuid-generator'],
  'word-counter': ['case-converter', 'markdown-preview', 'lorem-ipsum'],
  'markdown-preview': ['lorem-ipsum', 'text-diff', 'word-counter'],
  ...
  'meta-tags': ['css-gradient', 'slug-generator', 'dmarc-generator'],
  ...
  'http-headers-parser': ['openapi-validator', 'cache-control', 'user-agent-parser'],
  ...
  'curl-to-fetch': ['openapi-validator', 'csp-builder', 'http-status-codes'],
  ...
  'certificate-decoder': ['jwt-decoder', 'dmarc-generator', 'sha256-hash'],
  ...
  'html-formatter': ['html-minifier', 'html-entity', 'xml-formatter'],
  ...
  'svg-to-jsx': ['svg-minifier', 'image-to-base64', 'html-entity'],
  'svg-minifier': ['svg-to-jsx', 'js-minifier', 'html-minifier'],
  'css-clamp': ['css-box-shadow', 'css-gradient', 'color-contrast-checker'],
  'css-box-shadow': ['css-clamp', 'color-converter', 'color-contrast-checker'],
  ...
  'json-to-models': ['json-to-typescript', 'sql-formatter', 'json-to-sql'],
};
