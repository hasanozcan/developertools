    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center w-full overflow-hidden">
        <AdSense
          ...
          format="fluid"
          responsive={true}
          className="w-full min-h-[90px] overflow-hidden"
        />
      </div>
    </div>
  );
