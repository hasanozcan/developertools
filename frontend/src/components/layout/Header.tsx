  ...
  const navigation = useMemo(() => [
    { 
      ...
      tools: [
        ...
        { slug: 'json-string-escape', category: 'encoding', name: t('toolName.json-string-escape') },
    ...
    { 
      ...
      tools: [
        ...
        { slug: 'query-string-parser', category: 'converters', name: t('toolName.query-string-parser') },
    ...
    { 
      ...
      tools: [
        ...
        { slug: 'http-headers-parser', category: 'utilities', name: t('toolName.http-headers-parser') },
